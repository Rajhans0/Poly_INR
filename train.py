...
@click.option('--cfg',          help='Base configuration',                                      type=click.Choice(['gmgan']), default='gmgan', required=False)
...
def main(**kwargs):
    ...
    c.G_opt_kwargs.lr =  0.0025 if opts.glr is None else opts.glr
    ...
    c.G_kwargs = dnnlib.EasyDict(class_name='training.networks_gmgan.Generator',
    ...
    # c.D_kwargs = dnnlib.EasyDict(
    #     class_name='pg_modules.gm_discriminator.GMDiscriminator',
    #     backbones=['deit_base_distilled_patch16_224', 'tf_efficientnet_lite0'],
    #     diffaug=True,
    #     interp224=(c.training_set_kwargs.resolution < 224),
    #     backbone_kwargs=dnnlib.EasyDict(),
    ...
    c.loss_kwargs.blur_init_sigma = 2  # Blur the images seen by the discriminator for x kimg.
    ...
    c.loss_kwargs.cls_weight = 0.0  # use classifier guidance only for superresolution training 
    ...
    if opts.superres:
        ...
        c.G_kwargs = dnnlib.EasyDict(class_name='training.networks_gmgan.SuperresGenerator',
